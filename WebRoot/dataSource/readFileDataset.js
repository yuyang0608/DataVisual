function readFileDataset(id){
		...
		function(returnedData, status)
		{
			if("success"==status)
			{
				...
				var datatable="<div class='more'><img src='resources/images/more.png'/><a href=dataListShow?totalrow="+obj.totalrow+"&pageno=1 target='_blank'>显示更多数据</a></div><table width='100%' class='table table-hover'><thead><tr>";
